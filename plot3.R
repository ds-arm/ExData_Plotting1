...
# First use plot to set up the axis
# Use Sub_metering_1 as the reference - can see it has the max peak value 
#   of the three.  Alternative would be test which has max and the select that.
# Use with( ) to clean up the code 
with(projData, {
